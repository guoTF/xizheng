	                               ...
	                               <div class="form-group login-validate">
	                                 ...
	                                 <div class="form-group login-validate">
	                                  <label for="mail" class="">有效邮箱:</label>
	                                    <input class="form-control required"  placeholder="有效邮箱"  type="text"  name="mail" autocomplete="off" id="mail">
	                                </div>
	                                <div class="form-group login-validate">
	                                     <label for="department" class="areaValidate" style="line-height: 19px">所在部门:</label>
	                                    <input class="form-control required" placeholder="所在部门"  name="department" type="text" autofocus autocomplete="off" id="department" onkeyup="this.value=this.value.replace(/[^\u4e00-\u9fa5a-zA-Z0-9\w]/g,'');">
